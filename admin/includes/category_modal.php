        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
              <form class="form-horizontal" method="POST" action="category_add.php">
                ...
                <!-- <div class="form-group">
                    <label for="name" class="col-sm-3 control-label">Sub Category A</label>

                    <div class="col-sm-9">
                      <select class="form-control" id="subcategorya" name="subcategorya" required>
                ...
                <div class="form-group">
                    <label for="name" class="col-sm-3 control-label">Sub Category B</label>
            ...
            <div class="modal-body">
              <form class="form-horizontal" method="POST" action="category_edit.php">
                ...
                <!-- <div class="form-group">
                    ...
                    <div class="col-sm-9">
                      <select class="form-control" id="edit_subcategory1" name="subcategorya">
                      <option selected id="catselecteda"></option>
                      <?php
                        $conn = $pdo->open();
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                      <select class="form-control" id="edit_subcategory2" name="subcategoryb">
                      <option selected id="catselectedb"></option>
                      <?php
                        $conn = $pdo->open();
