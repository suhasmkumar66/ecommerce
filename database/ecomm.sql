...
CREATE TABLE `category` (
  ...
  `sub_category_id1` int(15) NOT NULL,
  `sub_category_id2` int(15) DEFAULT NULL,
...
INSERT INTO `category` (`id`, `name`, `sub_category_id1`, `sub_category_id2`, `cat_slug`) VALUES
(1, 'Laptops', 0, NULL, 'laptops'),
(2, 'Desktop PC', 0, NULL, 'desktop-pc'),
(3, 'Tablets', 0, NULL, 'tablets'),
(4, 'Smart Phones', 1, 4, ''),
(6, 'Mobile', 1, 3, ''),
(9, 'Earphones', 7, 8, '');
...
CREATE TABLE `sub_category` (
  `id` int(15) NOT NULL,
  `sub_categoryname` varchar(250) NOT NULL
...
INSERT INTO `sub_category` (`id`, `sub_categoryname`) VALUES
(1, 'touchscreen'),
(2, 'keypad'),
(3, 'android'),
(4, 'ios'),
