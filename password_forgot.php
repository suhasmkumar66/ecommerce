...
<div class="login-box">
  ...
  <div class="logo text-center">
						...
						<div>	<p class="login-box-msg">Enter email associated with account</p> </div>
    	<form action="reset.php" method="POST">
      		...
      		<div class="row">
    			<div class="col-xs-12 contact-btn text-center">
          			<button type="submit" class="btn  btn-flat fv-btn text-center" name="reset"><i class="fa fa-mail-forward"></i> Send</button>
        		</div>
      		</div>
    	</form>
      <br>
