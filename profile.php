	        				...
	        				<div class="col-sm-9">
	        					<div class="row pt--20">
	        						...
	        						<div class="col-sm-9">
	        							...
	        							<h4><?php echo $user['email']; ?></h4><br>
	        							<h4><?php echo (!empty($user['contact_info'])) ? $user['contact_info'] : 'N/a'; ?></h4><br>
	        							<h4><?php echo (!empty($user['address'])) ? $user['address'] : 'N/a'; ?></h4><br>
...
.pagination>.active>a, .pagination>.active>a:focus, .pagination>.active>a:hover, .pagination>.active>span, .pagination>.active>span:focus, .pagination>.active>span:hover {
    ...
    color: #fff;
    cursor: default;
      background-color: #6dbe50 !important;
    border-color: #6dbe50 !important;
	cursor:pointer;
}
